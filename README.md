...
Orders Table – order ID, date, time
Order Details Table – quantity, pizza ID
...
📊 Top Category: Classic (35%)
⏰ Peak Hours: 1 PM & 8 PM
...
Analyze order trends by time
Find category-wise performance
Compute rolling revenue
